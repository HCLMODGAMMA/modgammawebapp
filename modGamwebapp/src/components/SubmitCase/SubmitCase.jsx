            ...
            <Formik
                ...
                render={formProps => {
                    return(
                        <div>
                            <Header></Header>
                            <h2 className="text-center">Record Submission Form</h2>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <div className="row form-group">
                                            ...
                                            <div className="col-sm-8">
                                                <Field as="select" className="form-control" id="caseSubType" name="caseSubType" value={formFields.caseSubType} onChange={this.changeEventReact}>
                                                    <option value="">--Select--</option>
                                    ...
                                    <div className="row col-sm-12">
                                        <div className="col-sm-4 col-xs-12">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control col-sm-10 col-xs-12" placeholder="Record Name" name="siteName" value={formFields.siteName} onChange={this.changeEventReact} />
                                            </div>                                       
                                        </div>
                                        <div className="col-sm-4 col-xs-12">
                                            <div className="form-group">
                                                <label>Record Description:</label>
                                                <input type="text" className="form-control col-sm-10 col-xs-12" placeholder="Record Description" name="siteDescription" value={formFields.siteDescription} onChange={this.changeEventReact} />
                                            </div>
                                        </div>
                                        <div className="col-sm-4 col-xs-12">
                                            <div className="form-group">
                                                <label>Record Location:</label>
                                                <input type="text" className="form-control col-sm-10 col-xs-12" placeholder="Record Location" name="location" value={formFields.location} onChange={this.changeEventReact} />
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div className="text-center">
                                <button id="submitCase" type="submit" className="btn btn-primary">Submit Record</button>
